...
float to_add = 0.01;
float lower_voltage = 0;// Also used by Pressure()
float upper_voltage = 0;// Also used by Pressure()
int CURSOR = 15; //Also used by Output()

//Values used by Output()
int Pressure_range = 0;// Also used by Presssure()
int add = 1000;
